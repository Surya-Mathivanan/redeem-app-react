...
const Register = () => {
  ...
  const { login } = useAuth()
  const { addUser, findUser } = useDatabase()
    ...
    <div className="auth-container">
      <div className="auth-left">
        <div className="auth-left-content">
          ...
          <p className="auth-lead">Create an account to start managing your redeem codes</p>
          <p className="warning-text">⚠️ WARNING: Misuse of this platform will lead to automatic termination!</p>
          <ul className="auth-features warning-list">
            ...
            <li>
              Our AI system monitors user activity. If misuse is detected, the user will be terminated automatically.
            </li>
